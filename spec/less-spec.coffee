describe "Less grammar", ->
  ...
  it 'parses non-quoted urls followed by a format', ->
    ...
    expect(tokens[11]).toEqual value: ")", scopes: ['source.css.less', 'meta.property-list.css', 'meta.property-value.css', 'support.function.any-method.bultin.url.css', 'meta.brace.round.css']
